...
extern bool bip32DerivePrivatePlusChainCode(BigNum256 out, BigNum256 chain_code, const uint8_t *master_node, const uint32_t *path, const unsigned int path_length);
