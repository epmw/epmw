...
extern void swapEndianUniversal(uint8_t *buffer, const uint8_t op_size);
...
extern void bigModuloTo256(BigNum256 r, uint8_t *op1, uint8_t op1_size);
extern uint8_t bigAddVariableSizeNoModulo(uint8_t *r, uint8_t *op1, uint8_t *op2, uint8_t op_size);
extern uint8_t bigAddVariableSizeNoModuloDiffOpSizes(uint8_t *r, uint8_t *op1, uint8_t op1_size, uint8_t *op2, uint8_t op2_size);
